...
- Extended thinking: offer when generating steps for a complex or ambiguous
  task — operationally: many steps, unclear dependencies, or ambiguous scope
  (see SKILL.md § Extended Thinking Offer Protocol for the canonical trigger)
...
```
Read the template file from `[skill-dir]/templates/[template-name].md`
```
