...
- Extended thinking: offer when criteria have conflicting signals (some pass,
  some borderline, evidence is ambiguous)
- Checkpoint: write structured review (pass/fail per criterion, gaps, and
  suggested actions) to Task node in Step 4
