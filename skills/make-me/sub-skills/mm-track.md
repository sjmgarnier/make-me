...
- mm-track owns the checkpoint schedule defined in SKILL.md § Hybrid state
  protocol; sub-skills write to mnem at their designated checkpoints,
  mm-track audits and fills gaps
